...
export const getDailyChallenge = async () => {
  try {
    ...
    const response = await ai.models.generateContent({
      model: MODEL_NAME,
      contents:
        "Generate a simple, quick (under 5 mins), non-clinical mental wellbeing challenge for a teenager. Examples: 'Take a photo of something yellow', 'Write down 3 wins'. Return valid JSON with 'title' and 'description'.",
      config: {
    ...
    return {
      ...
      description: "Look out the window and find 3 things that are green.",
    };
  }
};
