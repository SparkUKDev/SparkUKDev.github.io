...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (userMenuBtn && userMenuDropdown) {
    ...
    userMenuBtn.addEventListener("click", (e) => {
      ...
      if (chevron) {
        chevron.style.transform = userMenuDropdown.classList.contains("hidden")
          ? "rotate(0deg)"
          : "rotate(180deg)";
      }
      // set ARIA attributes
  ...
  const closeSafetyBtns = document.querySelectorAll(
    "#close-safety-modal, #close-safety-action"
  );
